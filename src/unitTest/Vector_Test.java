...
public class Vector_Test {
	...
	public void testNormalize() {
		Vector vector1=new Vector(new Point3D(new Coordinate(2),new Coordinate(1),new Coordinate(2)));
		vector1.normalize();
		Vector vector2=new Vector(new Point3D(new Coordinate(2/3f),new Coordinate(1/3f),new Coordinate(2/3f)));
	...
	////// tests by david chean
	 ...
	 @Test
	    public void Test06() {
	        ...
	        v1.add(v2);
	        assertTrue(v1.compareTo(new Vector(new Point3D(new Coordinate(0.0), new Coordinate(0.0), new Coordinate(0.0)))) == 0);
	    ...
	    public void Test07() {
	        ...
	        v1.subtract(v2);
	        assertTrue(v1.compareTo(new Vector(new Point3D(new Coordinate(2.0), new Coordinate(2.0), new Coordinate(2.0)))) == 0);

	        v2.subtract(v1);
	        assertTrue(v2.compareTo(new Vector(new Point3D(new Coordinate(-3.0), new Coordinate(-3.0), new Coordinate(-3.0)))) == 0);
	    ...
	    public void Test08() {
	        ...
	        v1.scale(-2);
	        assertTrue(v1.compareTo(new Vector(new Point3D(new Coordinate(-4.0), new Coordinate(-4.0), new Coordinate(-4.0)))) == 0);
	    }
