...
public class Sphere_TestTest {
	...
	/*
	 * @Test public void TestGetNormal2() { Sphere sphere = new Sphere(10, new
	 * Point3D(0.0, 0.0, -3.0)); Vector normal = sphere.getNormal(new
	 * Point3D(5.0, 5.0, -3.0)); System.out.println(normal);
	 * assertEquals("Wrong Normal! ", normal.toString(),
	 * "( 0.71 , 0.71 , 0.00 )"); }
	 */
}
